...
public class DatabaseClient {
    ...
    RoomDatabase.Callback roomDatabaseCallback = new RoomDatabase.Callback() {
        ...
        public void onCreate(@NonNull SupportSQLiteDatabase db) {
            ...
            //
            db.execSQL("INSERT INTO users (firstName, lastName, score) VALUES(\"Syméon\", \"De Almeida\", 5);");
            db.execSQL("INSERT INTO users (firstName, lastName, score) VALUES(\"Florian\", \"Cuerq\", 50);");
